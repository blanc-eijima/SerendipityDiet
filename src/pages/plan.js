  ...
  return (
    <Layout>
      <Section title={pagemeta.subtitle} sub={true} id={pagemeta.slug} svg={true}>
        ...
        <PlanBox course="silver" title="シルバーコース" price="35,000" reverse imageData={silverImageData}>
          <p>
            現状をヒヤリングして、
            <br />
        ...
        <PlanBox course="gold" title="ゴールドコース" price="65,000" imageData={goldImageData}>
        ...
        <PlanBox course="platinum" title="プラチナコース" price="95,000" imageData={platinumImageData} reverse>
