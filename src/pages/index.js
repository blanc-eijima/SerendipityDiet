      ...
      <Layout>
        ...
        <Section id="qa" className="qa-section">
          ...
          <div className="qa-container">
            ...
            <div className="qa-item">
              <p className="qa-question" onClick={() => toggleOpen(2)}>
            ...
            <div className="qa-item">
              <p className="qa-question" onClick={() => toggleOpen(3)}>
            ...
            <div className="qa-item">
              <p className="qa-question" onClick={() => toggleOpen(4)}>
            ...
            <div className="qa-item">
              <p className="qa-question" onClick={() => toggleOpen(5)}>
            ...
            <div className="qa-item">
              <p className="qa-question" onClick={() => toggleOpen(6)}>
                食事制限は必要ですか？
              </p>
            ...
            <div className="qa-item">
              <p className="qa-question" onClick={() => toggleOpen(9)}>
                運動は週に何回くらい行えば良いですか？
              </p>
            ...
            <div className="qa-item">
              <p className="qa-question" onClick={() => toggleOpen(10)}>
